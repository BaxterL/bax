...
execute store result score #tal.a_star.point1.y tal.a_star.temp run data get entity @e[limit=1,sort=nearest,tag=tal.a_star.start] Pos[1]
...
execute as @e[tag=tal.a_star.armor_stand,tag=tal.a_star.start] at @s run function bax:func/a_star/3d/loop/loop_check