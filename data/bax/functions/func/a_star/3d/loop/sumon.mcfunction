execute unless entity @s[tag=have] positioned ~1 ~ ~ if score #tal.a_star.H_all tal.a_star.temp = #tal.a_star.H1 tal.a_star.temp run summon marker ~ ~ ~ {Tags:["tal.a_star.armor_stand","tal.a_star.new"]}
...
execute unless entity @s[tag=have] positioned ~ ~ ~1 if score #tal.a_star.H_all tal.a_star.temp = #tal.a_star.H3 tal.a_star.temp run summon marker ~ ~ ~ {Tags:["tal.a_star.armor_stand","tal.a_star.new"]}
...
execute unless entity @s[tag=have] positioned ~-1 ~ ~ if score #tal.a_star.H_all tal.a_star.temp = #tal.a_star.H2 tal.a_star.temp run summon marker ~ ~ ~ {Tags:["tal.a_star.armor_stand","tal.a_star.new"]}
...
execute unless entity @s[tag=have] positioned ~ ~ ~-1 if score #tal.a_star.H_all tal.a_star.temp = #tal.a_star.H4 tal.a_star.temp run summon marker ~ ~ ~ {Tags:["tal.a_star.armor_stand","tal.a_star.new"]}
...
execute unless entity @s[tag=have] positioned ~ ~1 ~ if score #tal.a_star.H_all tal.a_star.temp = #tal.a_star.H5 tal.a_star.temp run summon marker ~ ~ ~ {Tags:["tal.a_star.armor_stand","tal.a_star.new"]}
...
execute unless entity @s[tag=have] positioned ~ ~-1 ~ if score #tal.a_star.H_all tal.a_star.temp = #tal.a_star.H6 tal.a_star.temp run summon marker ~ ~ ~ {Tags:["tal.a_star.armor_stand","tal.a_star.new"]}
...
execute unless entity @s[tag=have] positioned ~1 ~ ~1 if score #tal.a_star.H_all tal.a_star.temp = #tal.a_star.H7 tal.a_star.temp run summon marker ~ ~ ~ {Tags:["tal.a_star.armor_stand","tal.a_star.new"]}
...
execute unless entity @s[tag=have] positioned ~1 ~ ~-1 if score #tal.a_star.H_all tal.a_star.temp = #tal.a_star.H8 tal.a_star.temp run summon marker ~ ~ ~ {Tags:["tal.a_star.armor_stand","tal.a_star.new"]}
...
execute unless entity @s[tag=have] positioned ~-1 ~ ~1 if score #tal.a_star.H_all tal.a_star.temp = #tal.a_star.H9 tal.a_star.temp run summon marker ~ ~ ~ {Tags:["tal.a_star.armor_stand","tal.a_star.new"]}
...
execute unless entity @s[tag=have] positioned ~-1 ~ ~-1 if score #tal.a_star.H_all tal.a_star.temp = #tal.a_star.H10 tal.a_star.temp run summon marker ~ ~ ~ {Tags:["tal.a_star.armor_stand","tal.a_star.new"]}
