...
scoreboard players remove #tal.a_star.point1.y tal.a_star.temp 1
...
#总代价
scoreboard players operation #tal.a_star.H6 tal.a_star.temp = #tal.a_star.distance tal.a_star.temp
# scoreboard players operation @s tal.a_star.d = #tal.a_star.distance tal.a_star.temp

scoreboard players operation #tal.a_star.H6 tal.a_star.temp += #tal.a_star.cost tal.a_star.temp
