...
#总代价
scoreboard players operation #tal.a_star.H9 tal.a_star.temp = #tal.a_star.distance tal.a_star.temp
# scoreboard players operation @s tal.a_star.d = #tal.a_star.distance tal.a_star.temp

# scoreboard players add #tal.a_star.H9 tal.a_star.temp 1
scoreboard players operation #tal.a_star.H9 tal.a_star.temp += #tal.a_star.cost tal.a_star.temp
