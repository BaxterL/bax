...
#y
scoreboard players operation #tal.a_star.point2.y tal.a_star.temp -= #tal.a_star.point1.y tal.a_star.temp
scoreboard players set #-1 tal.a_star.temp -1
#取正
execute if score #tal.a_star.point2.y tal.a_star.temp matches ..0 run scoreboard players operation #tal.a_star.point2.y tal.a_star.temp *= #-1 tal.a_star.temp
...
scoreboard players operation #tal.a_star.point2.y tal.a_star.temp *= #tal.a_star.point2.y tal.a_star.temp
scoreboard players operation #tal.a_star.distance tal.a_star.temp += #tal.a_star.point2.y tal.a_star.temp
#开根*100
# function bax:func/a_star/3d/compute/f
# scoreboard players operation #tal.a_star.distance tal.a_star.temp /= #100 tal.a_star.temp
