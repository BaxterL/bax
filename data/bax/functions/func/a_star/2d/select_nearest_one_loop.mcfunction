...
execute positioned -29999998 0 2022241 run summon marker ~ ~ ~ {NoGravity:1b,Tags:["tal.a_star.a"]}

execute positioned -29999998 0 2022241 store result entity @e[type=marker,limit=1,sort=nearest,tag=tal.a_star.a,distance=..0.1] Pos[1] double 1.0 run scoreboard players get @s tal.a_star.temp
# execute positioned -29999998 0 2022241 run kill @e[type=marker,distance=..2]
# execute positioned -29999998 0 2022241 as @e[type=marker,limit=1,sort=nearest] run tellraw @p [{"nbt":"Pos[1]","entity": "@s"}]
