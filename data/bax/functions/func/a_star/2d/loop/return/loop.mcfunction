...
execute unless entity @e[tag=tal.a_star.end_back,distance=..10] run function bax:func/a_star/2d/end/start

execute as @e[tag=tal.a_star.end_back,limit=1,sort=nearest] at @s run function bax:func/a_star/2d/loop/return/loop
# execute as @e[tag=tal.a_star.end_back,limit=1,sort=nearest] at @s run schedule function bax:func/a_star/2d/loop/return/start 1t replace 
