...
scoreboard players operation @s bax.temp -= 102400 bax.sys
scoreboard players operation @s bax.temp *= -1 bax.sys
scoreboard players operation $a bax.temp = @s bax.temp
scoreboard players operation @s bax.temp /= 100 bax.sys
scoreboard players operation $a bax.temp %= 100 bax.sys
setblock 0 -64 0 oak_sign{Text1:'[{"score": {"name": "@e[tag=bax.lib.test_golem,limit=1]","objective": "bax.temp"},"color": "red"},{"text": ".","color": "red"},{"score": {"name": "$a","objective": "bax.temp"}}]'}
